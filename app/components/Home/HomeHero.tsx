...
export default function HomeHero() {
  return (
    <section className="flex flex-col justify-center items-center h-screen min-h-full relative z-10 mx-20">
      <div>
        <h1 className="text-center 2xl:text-9xl xl:text-8xl lg:text-7xl md:text-6xl sm:text-5xl text-2xl pb-5 ">
          Daniel Zyrick Gayao
        </h1>
      </div>
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col absolute bottom-7 right-0 font-extralight 2xl:text-xl">
          <Link
